# Xulosa AI — Sayt (Rahbarlar uchun)

**Istalgan tuzilishdagi** Excel (yoki CSV) faylni yuklab, avtomatik dashboard va AI orqali xulosa oladigan sayt. Bitta qat'iy shablonga bog'liq emas — varaq nomlari, ustun nomlari, ustunlar soni qanday bo'lishidan qat'iy nazar ishlaydi: fayl yuklanganda har bir ustun sana/son/matn ekanligi avtomatik aniqlanadi, shunga qarab KPI'lar, grafiklar va jadval o'zi tuziladi. Bir nechta varaqli fayl yuklansa, har bir varaq alohida ko'rish uchun ochiladi (tab orqali). Bir nechta fayl ketma-ket yuklansa, ularning barchasi ro'yxatda saqlanadi va istalgan birini tanlab ko'rish mumkin. Barcha rahbarlar bitta havola orqali kiradi va bir xil ma'lumotni ko'radi.
